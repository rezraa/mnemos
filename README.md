...
**Tools do structural comparisons** against curated JSON knowledge. **The agent does all reasoning.** This separation is critical — an earlier architecture where tools tried to be smart (regex banks, fuzzy keyword scoring) actively degraded results.
...
Copyright (c) 2026 Reza Malik. [AGPL v3](LICENSE)
